...
public abstract class RichTextTag
{
    ...
    /// </summary>
    /// <remarks>
    ///     This property is used to determine what delimiters between the tag name and parameters (e.g. space, equal sign,
    ///     none) will be allowed. For multiple tag style, create different classes.
    /// </remarks>
    ...
    /// <remarks>
    ///     If the tag does not have parameters, <paramref name="parameters" /> will always be <see cref="string.Empty" />
    ///     .
    /// </remarks>
