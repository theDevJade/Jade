...
public class ParserContext : TextInfo, IDisposable
{
    ...
    ///     <see cref="Tags.ConcreteTags.CloseNoparseTag" />.
    /// </summary>
    ...
    /// </summary>
    /// <typeparam name="T">
    ///     The type of the <see cref="RichTextTag" /> to be added as an ending tag (as a
    ///     <see cref="SharedTag{Tags}" />).
    /// </typeparam>
    ...
    /// <summary>
    ///     Removes a <see cref="RichTextTag" /> from the list list of tags that will be added to the end of the parser's
    ///     result.
    /// </summary>
    /// <typeparam name="T">
    ///     The type of the <see cref="RichTextTag" /> to be removed from the ending tags (as a
    ///     <see cref="SharedTag{Tags}" />).
    /// </typeparam>
    ...
    {
        foreach (var tag in this.endingTags.ToList())
        {
            tag.HandleTag(this);
        }

        foreach (var t in this.SizeTags)
        {
