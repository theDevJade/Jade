...
public static class Constants
{
    ...
    /// </summary>
    public static ReadOnlyCollection<int> ValidColorSizes { get; } = new(
        new[]
        {
            3,
            4,
    ...
    /// </summary>
    public static ReadOnlyCollection<string> Alignments { get; } = new(
        new[]
        {
            "left",
            "center",
    ...
    /// </summary>
    public static ReadOnlyCollection<string> Colors { get; } = new(
        new[]
        {
            "black",
            "blue",
