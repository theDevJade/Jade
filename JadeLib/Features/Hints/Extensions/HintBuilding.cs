...
public static class HintBuilding
{
    ...
    public static float GetFunctionalPosition(this Element element)
    {
        ...
        return HintTility.ScaledPositionToFunctional(element.Position);
    }
    ...
    public static StringBuilder AddLinebreak(this StringBuilder sb)
    {
        return sb.Append('\n');
    }
    ...
    /// <returns>A reference to the original <see cref="StringBuilder" />.</returns>
    public static StringBuilder SetSize(
    ...
    /// <returns>A reference to the original <see cref="StringBuilder" />.</returns>
    public static StringBuilder SetLineHeight(
        this StringBuilder sb,
        float size,
        MeasurementUnit style = MeasurementUnit.Pixels)
    {
    ...
    /// <returns>A reference to the original <see cref="StringBuilder" />.</returns>
    public static StringBuilder SetAlpha(this StringBuilder sb, byte alpha)
    {
        return sb.Append($"<alpha={alpha:X2}>");
    }
    ...
    /// <param name="alpha">The alpha (0-255) of the color.</param>
    /// <returns>A reference to the original <see cref="StringBuilder" />.</returns>
    public static StringBuilder SetAlpha(this StringBuilder sb, int alpha)
    {
        return sb.Append($"<alpha={alpha:X2}>");
    }
    ...
    /// <param name="sb">The <see cref="StringBuilder" /> to use.</param>
    /// <returns>A reference to the original <see cref="StringBuilder" />.</returns>
    public static StringBuilder SetBold(this StringBuilder sb)
    {
        return sb.Append("<b>");
    }
    ...
    /// <param name="sb">The <see cref="StringBuilder" /> to use.</param>
    /// <returns>A reference to the original <see cref="StringBuilder" />.</returns>
    public static StringBuilder SetItalics(this StringBuilder sb)
    {
        return sb.Append("<i>");
    }
    ...
    /// <param name="sb">The <see cref="StringBuilder" /> to use.</param>
    /// <returns>A reference to the original <see cref="StringBuilder" />.</returns>
    public static StringBuilder SetStrikethrough(this StringBuilder sb)
    {
        return sb.Append("<s>");
    }
    ...
    /// <param name="sb">The <see cref="StringBuilder" /> to use.</param>
    /// <returns>A reference to the original <see cref="StringBuilder" />.</returns>
    public static StringBuilder SetUnderline(this StringBuilder sb)
    {
        return sb.Append("<u>");
    }
    ...
    /// <returns>A reference to the original <see cref="StringBuilder" />.</returns>
    public static StringBuilder SetIndent(
        this StringBuilder sb,
        float indent,
        MeasurementUnit style = MeasurementUnit.Pixels)
    {
    ...
    /// <returns>A reference to the original <see cref="StringBuilder" />.</returns>
    public static StringBuilder SetScale(this StringBuilder sb, float scale)
    {
        return sb.Append($"<scale={scale}>");
    }
    ...
    /// <returns>A reference to the original <see cref="StringBuilder" />.</returns>
    public static StringBuilder SetMonospace(
        this StringBuilder sb,
        float spacing,
        MeasurementUnit style = MeasurementUnit.Pixels)
    {
    ...
    /// <returns>A reference to the original <see cref="StringBuilder" />.</returns>
    public static StringBuilder SetMargins(
        this StringBuilder sb,
        float margins,
        MeasurementUnit style = MeasurementUnit.Pixels)
    {
    ...
    /// <param name="sb">The <see cref="StringBuilder" /> to use.</param>
    /// <returns>A reference to the original <see cref="StringBuilder" />.</returns>
    public static StringBuilder SetNobreak(this StringBuilder sb)
    {
        return sb.Append("<nobr>");
    }
    ...
    /// <param name="sb">The <see cref="StringBuilder" /> to use.</param>
    /// <returns>A reference to the original <see cref="StringBuilder" />.</returns>
    public static StringBuilder SetNoparse(this StringBuilder sb)
    {
        return sb.Append("<noparse>");
    }
    ...
    /// <returns>A reference to the original <see cref="StringBuilder" />.</returns>
    public static StringBuilder SetRotation(this StringBuilder sb, int rotation)
    {
        return sb.Append($"<rotate=\"{rotation}\">");
    }
    ...
    /// <param name="sb">The <see cref="StringBuilder" /> to use.</param>
    /// <returns>A reference to the original <see cref="StringBuilder" />.</returns>
    public static StringBuilder SetSubscript(this StringBuilder sb)
    {
        return sb.Append("<sub>");
    }
    ...
    /// <param name="sb">The <see cref="StringBuilder" /> to use.</param>
    /// <returns>A reference to the original <see cref="StringBuilder" />.</returns>
    public static StringBuilder SetSuperscript(this StringBuilder sb)
    {
        return sb.Append("<sup>");
    }
    ...
    /// <returns>A reference to the original <see cref="StringBuilder" />.</returns>
    public static StringBuilder SetWidth(
        this StringBuilder sb,
        float offset,
        MeasurementUnit style = MeasurementUnit.Pixels)
    {
    ...
    /// <returns>A reference to the original <see cref="StringBuilder" />.</returns>
    public static StringBuilder AddHorizontalPos(
        this StringBuilder sb,
        float margins,
        MeasurementUnit style = MeasurementUnit.Pixels)
    {
    ...
    /// <param name="style">The measurement style of the pos tag.</param>
    /// <returns>A reference to the original <see cref="StringBuilder" />.</returns>
    public static StringBuilder AddSpace(
        this StringBuilder sb,
        float margins,
        MeasurementUnit style = MeasurementUnit.Pixels)
    {
    ...
    /// <returns>A reference to the original <see cref="StringBuilder" />.</returns>
    public static StringBuilder AddVOffset(
        this StringBuilder sb,
        float offset,
        MeasurementUnit style = MeasurementUnit.Pixels)
    {
    ...
    /// <returns>A reference to the original <see cref="StringBuilder" />.</returns>
    public static StringBuilder AddSprite(this StringBuilder sb, int index)
    {
        return sb.Append($"<sprite={index}>");
    }
    ...
    /// <returns>A reference to the original <see cref="StringBuilder" />.</returns>
    public static StringBuilder AddSprite(this StringBuilder sb, int index, Color color)
    {
        return sb.Append($"<sprite index={index} color={ConvertToHex(color)}>");
    }
    ...
    /// <param name="sb">The <see cref="StringBuilder" /> to use.</param>
    /// <returns>A reference to the original <see cref="StringBuilder" />.</returns>
    public static StringBuilder CloseColor(this StringBuilder sb)
    {
    ...
    /// <param name="sb">The <see cref="StringBuilder" /> to use.</param>
    /// <returns>A reference to the original <see cref="StringBuilder" />.</returns>
    public static StringBuilder CloseAlpha(this StringBuilder sb)
    {
        return sb.Append("</alpha>");
    }
    ...
    /// <param name="sb">The <see cref="StringBuilder" /> to use.</param>
    /// <returns>A reference to the original <see cref="StringBuilder" />.</returns>
    public static StringBuilder CloseSize(this StringBuilder sb)
    {
    ...
    /// <param name="sb">The <see cref="StringBuilder" /> to use.</param>
    /// <returns>A reference to the original <see cref="StringBuilder" />.</returns>
    public static StringBuilder CloseLineHeight(this StringBuilder sb)
    {
        return sb.Append("</line-height>");
    }
    ...
    /// <param name="sb">The <see cref="StringBuilder" /> to use.</param>
    /// <returns>A reference to the original <see cref="StringBuilder" />.</returns>
    public static StringBuilder CloseBold(this StringBuilder sb)
    {
        return sb.Append("</b>");
    }
    ...
    /// <param name="sb">The <see cref="StringBuilder" /> to use.</param>
    /// <returns>A reference to the original <see cref="StringBuilder" />.</returns>
    public static StringBuilder CloseItalics(this StringBuilder sb)
    {
        return sb.Append("</i>");
    }
    ...
    /// <param name="sb">The <see cref="StringBuilder" /> to use.</param>
    /// <returns>A reference to the original <see cref="StringBuilder" />.</returns>
    public static StringBuilder CloseStrikethrough(this StringBuilder sb)
    {
        return sb.Append("</s>");
    }
    ...
    /// <param name="sb">The <see cref="StringBuilder" /> to use.</param>
    /// <returns>A reference to the original <see cref="StringBuilder" />.</returns>
    public static StringBuilder CloseUnderline(this StringBuilder sb)
    {
        return sb.Append("</u>");
    }
    ...
    /// <param name="sb">The <see cref="StringBuilder" /> to use.</param>
    /// <returns>A reference to the original <see cref="StringBuilder" />.</returns>
    public static StringBuilder CloseIndent(this StringBuilder sb)
    {
    ...
    /// <param name="sb">The <see cref="StringBuilder" /> to use.</param>
    /// <returns>A reference to the original <see cref="StringBuilder" />.</returns>
    public static StringBuilder CloseScale(this StringBuilder sb)
    {
    ...
    /// <param name="sb">The <see cref="StringBuilder" /> to use.</param>
    /// <returns>A reference to the original <see cref="StringBuilder" />.</returns>
    public static StringBuilder CloseMonospace(this StringBuilder sb)
    {
        return sb.Append("</mspace>");
    }
    ...
    /// <param name="sb">The <see cref="StringBuilder" /> to use.</param>
    /// <returns>A reference to the original <see cref="StringBuilder" />.</returns>
    public static StringBuilder CloseSubscript(this StringBuilder sb)
    {
        return sb.Append("</subscript>");
    }
    ...
    /// <param name="sb">The <see cref="StringBuilder" /> to use.</param>
    /// <returns>A reference to the original <see cref="StringBuilder" />.</returns>
    public static StringBuilder CloseSuperscript(this StringBuilder sb)
    {
        return sb.Append("</superscript>");
    }
    ...
    /// <param name="sb">The <see cref="StringBuilder" /> to use.</param>
    /// <returns>A reference to the original <see cref="StringBuilder" />.</returns>
    public static StringBuilder CloseRotation(this StringBuilder sb)
    {
        return sb.Append("</rotate>");
    }
    ...
    /// <param name="sb">The <see cref="StringBuilder" /> to use.</param>
    /// <returns>A reference to the original <see cref="StringBuilder" />.</returns>
    public static StringBuilder CloseMargins(this StringBuilder sb)
    {
        return sb.Append("</margins>");
    }
    ...
    /// <param name="sb">The <see cref="StringBuilder" /> to use.</param>
    /// <returns>A reference to the original <see cref="StringBuilder" />.</returns>
    public static StringBuilder CloseMark(this StringBuilder sb)
    {
        return sb.Append("</mark>");
    }
    ...
    /// <param name="sb">The <see cref="StringBuilder" /> to use.</param>
    /// <returns>A reference to the original <see cref="StringBuilder" />.</returns>
    public static StringBuilder CloseNobreak(this StringBuilder sb)
    {
        return sb.Append("</nobr>");
    }
    ...
    /// <param name="sb">The <see cref="StringBuilder" /> to use.</param>
    /// <returns>A reference to the original <see cref="StringBuilder" />.</returns>
    public static StringBuilder CloseNoparse(this StringBuilder sb)
    {
        return sb.Append("</noparse>");
    }
    ...
    /// <param name="sb">The <see cref="StringBuilder" /> to use.</param>
    /// <returns>A reference to the original <see cref="StringBuilder" />.</returns>
    public static StringBuilder CloseVOffset(this StringBuilder sb)
    {
        return sb.Append("</voffset>");
    }
    ...
    /// <param name="sb">The <see cref="StringBuilder" /> to use.</param>
    /// <returns>A reference to the original <see cref="StringBuilder" />.</returns>
    public static StringBuilder CloseWidth(this StringBuilder sb)
    {
